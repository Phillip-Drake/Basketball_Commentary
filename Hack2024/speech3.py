...
for i in range(len(array)):
    ...
    gif_clip = VideoFileClip(gifs[i])
    gif_clip.set_duration(1.5)
    ...
    video_clip = CompositeVideoClip([video_clip, text_clip.set_position((880, 840)).set_start(delay_duration), gif_clip.set_position((x_pos,y_pos)).set_start(delay_duration)])
...
video_clip.write_videofile("output_video2EX.mp4", codec="libx264", audio_codec="aac")